export { Provider, batch, connect, connectAdvanced, useDispatch, useSelector, useStore } from 'react-redux';
...
var createStore = function createStore() {
  ...
  var nextConfig = merge(baseConfig, config); // 实例化 reactx
  ...
  var reactXEnhancer = applyMiddleware(actionMiddleware);
  ...
  var store = createStore$1(rootReducer, nextPreloadedState, nextEnhancer); // [todo]
  // 自定义 store 的方法
  // 动态注册新的模块
